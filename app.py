...
import requests  # For simulating real-time data fetching
import re  # For compliance scans
from sentence_transformers import SentenceTransformer  # For embeddings
import chromadb  # For vector database
import random
from deep_translator import GoogleTranslator
from lingua import Language, LanguageDetectorBuilder  # Новая библиотека для точного определения языка
import json
...
# Configure PostgreSQL database (update with your actual credentials)
